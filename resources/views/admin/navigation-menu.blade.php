        ...
        <div class="flex justify-between" style="height: 40px">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{route('/admin/home')}}" style="font-family: 'Script MT';font-size:25px;color:black">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex nav">
                    <x-jet-nav-link href="{{ route('/admin/home') }}" :active="request()->routeIs('/admin/home')" style="font-size:13px;">
                        {{ __('Home') }}
                    </x-jet-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden" style="background-color: rgba(255,255,255,1.0);position: absolute;z-index: 100;width:100%;">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link href="{{ route('/admin/profile') }}" :active="request()->routeIs('/admin/profile')">
                    {{ __('Profile') }}
                </x-jet-responsive-nav-link>
