    ...
    <div id="more" style="width:99%;height:100vh;display:none;;justify-content:end;align-items:center">
        <div style="width:100%;height:80%;display:grid;grid-template-columns: repeat(2,25em);justify-content: center;gap:50px">
            ...
            <div class="cards" style="display:flex;justify-content: center;align-items: center;gap:20px;padding:10px">
                ...
                <p>Notifications of speacial Rooms/Halls reservations will reach to accept or refuse them!</p>
            </div>
            <div class="cards" style="display:flex;justify-content: center;align-items: center;gap:20px;padding:10px">
                <img src="{{URL('images/room.png')}}" alt="calendar" style="height:6em;width:6em;padding:10px">
                <p>Here you can manage Rooms/Halls which your faculty contains.</p>
            </div>
            <div class="cards" style="display:flex;justify-content: center;align-items: center;gap:20px;padding:10px">
                <img src="{{URL('images/manager.png')}}" alt="calendar" style="height:6em;width:6em;padding:10px">
                <p>You can also manage your faculty professors to offer a more secured system!</p>
            </div>
        </div>
