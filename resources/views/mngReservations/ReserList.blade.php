...
<body>
  ...
  <div style="display: flex;width:100%;justify-content:center;align-items:center">
    <div class="card mb-3" style="width:90%;margin-top:30px">
      ...
      <div class="card-body">
        <div style="display: flex;justify-content: space-between;width:92.5%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="display: flex;gap:20px;justify-content:center">
                ...
                <a href="{{ url('/user/editR/'.$reservation->id) }}" class="btn btn-sm btn-warning" style="background-color: #a4c8d5;color:white;border:none;box-shadow: 0px 2px 4px gray;border-radius:15px;padding:3.7px 18px;">Edit</a>
              </td>
            </tr>
            @endif
            @endforeach
